...
import com.example.modul2_kel4.DetailActivity;
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataItem selectedUser = dataUser.get(i);
                intent.putExtra("avatar", selectedUser.getAvatar());
                intent.putExtra("email", selectedUser.getEmail());
                intent.putExtra("id", Integer.toString(selectedUser.getId()));
                intent.putExtra("firstName", selectedUser.getFirstName());
                intent.putExtra("lastName", selectedUser.getLastName());
